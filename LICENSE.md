...
> Discord webhook sender tool, embeds messages formatting 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

📨 &nbsp;**Rich embeds** — full embed builder with all fields

🖼️ &nbsp;**Images** — attach images and thumbnails

⏰ &nbsp;**Scheduled** — queue messages to send later

🔄 &nbsp;**Templates** — save and reuse embed templates

📋 &nbsp;**Bulk send** — send to multiple webhooks at once

📊 &nbsp;**Delivery log** — confirm all messages sent
